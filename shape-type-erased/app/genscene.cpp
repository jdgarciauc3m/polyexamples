...
dsl::shape random_shape(G && g) {
  ...
  switch (kind(g)) {
    case 0: return dsl::shape{dsl::rectangle{gx(g), gy(g), gw(g), gh(g)}};
    case 1: return dsl::shape{dsl::circle{gx(g), gy(g), r(g)}};
  }
...
int main(int argc, const char ** argv) {
  ...
  cout << "sizeof(shape)= " << sizeof(dsl::shape) << endl;
